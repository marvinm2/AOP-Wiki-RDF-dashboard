...
def database_snapshot():
    ...
    """
    return render_template("latest.html", methodology_notes=methodology_notes, sparql_endpoint=Config.SPARQL_ENDPOINT, latest_graph_uri=f"http://aopwiki.org/graph/{_latest_version}" if _latest_version else "", active_page='snapshot')
...
def historical_trends():
    ...
    """
    return render_template("trends_page.html", methodology_notes=methodology_notes, sparql_endpoint=Config.SPARQL_ENDPOINT, latest_graph_uri=f"http://aopwiki.org/graph/{_latest_version}" if _latest_version else "", active_page='trends')
